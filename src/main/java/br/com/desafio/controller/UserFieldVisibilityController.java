...
import br.com.desafio.service.UserFieldVisibilityService;
...
public class UserFieldVisibilityController {
    ...
    @GetMapping("/{id}")
    public UserFieldVisibility findById(@PathVariable("id") Long id) throws UserVisibilityNotFoundException {
